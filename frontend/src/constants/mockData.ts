...
export const MOCK_CATEGORIES: CategoryItem[] = [
  ...
  },
  {
    ...
    itemCount: 2,
    description: 'Slender multi-color pencil crackers and repeating roman candles.',
    imageUrl: LOCAL_PRODUCT_IMAGES.PENCIL_CANDLES,
  },
  {
    id: '660000000000000000000007',
    name: 'Aerial Cakes & Multi-Shots',
  ...
  },
  {
    ...
    name: 'Gift Boxes & Assortments',
    iconName: 'inventory-2',
    itemCount: 2,
    isTrending: true,
    tag: 'Best Value',
    description: 'All-in-one family assortments and classic 1000 wala festival boxes.',
    imageUrl: LOCAL_PRODUCT_IMAGES.GIFT_BOX,
  },
];
